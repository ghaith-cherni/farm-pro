...
public class OwnerController {
    ...
    public ResponseEntity<String> updateOwner(@RequestBody List<Animal2Owner> updatedData) {
        System.out.println("updatedData");
        System.out.println(updatedData);
        ownerService.updateOwners(updatedData);
        return ResponseEntity.status(HttpStatus.OK).body("owners updated ");
    }
}
